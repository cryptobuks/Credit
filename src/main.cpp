...
uint256 hashGenesisBlock("0x017c4a33cbc7d911e313b3054b161df548f418cdce849a6f97a90627abc9b21a");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520134678); // Credit: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 60000000); // Credit: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 602400; // Credit: 3.5 days
static const int64 nTargetSpacing = 240; // Credit: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa514e8f24b3510d1e5867b74c0b31742d2ad90d650509523d8a66518cb14e99c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("83bf53ca9017de367e87a94140c35455951d470ffcb8a92b6b8137ac07fa2ae11cf6d85c087255284136669de6e2177381e8b48dc47b685edf78191a42dda5d8a7") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1514187649;
        block.nBits    = 520134678;
        block.nNonce   = 1790688852;

        if (fTestNet)
        {
            block.nTime    = 1514187649;
            block.nNonce   = 3077904660;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf5c6962d1ddacf036f0e9c758e75bda9d54df508cd22e2465b82437d2d8a661b"));
        block.print();
